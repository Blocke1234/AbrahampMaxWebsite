...
const RECOMMENDED_PRODUCTS = [
  ...
  },
  {
    ...
    description: 'Non-greasy arnica & magnesium glide oil with a jojoba and grapeseed base. Lets the massager and your hands work deeper without dragging — hypoallergenic and fast-absorbing, so skin stays clean, not slick.',
    price: 26.99,
    stripePriceId: 'price_REPLACE_ME_MASSAGE_OIL',
